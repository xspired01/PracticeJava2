...
public class TestGoods {
	...
	public static void main(String[] args) {
		...
		System.out.println(paint + " is flammable? " + paint.isFlammable() + " and weights " + paint.weight() + " per " + paint.getUnitOfMeasure() + ". Can ship via Post office? " + paint.canShipViaPostOffice());
